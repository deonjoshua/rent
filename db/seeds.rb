...
User.create!(email: "deon@gmail.com", password: "deonnn", first_name: "Deon", last_name:"Joshua", address: "Armadale", phone_number:"12345",image_url: "https://i.pravatar.cc/150?img=68")
User.create!(email: "wendy@gmail.com", password: "wendyy", first_name: "Wendy", last_name:"Henry", address: "Carnegie", phone_number:"12345",image_url: "https://i.pravatar.cc/150?img=46")
User.create!(email: "bob@gmail.com", password: "bobbbb", first_name: "Bob", last_name:"Marley", address: "Hawthorn", phone_number:"12345",image_url:"https://i.pravatar.cc/150?img=65 ")
User.create!(email: "lucy@gmail.com", password: "lucyyy", first_name: "Lucy", last_name:"Santiago", address: "Newport", phone_number:"12345", image_url:"https://i.pravatar.cc/150?img=49")
User.create!(email: "john@gmail.com", password: "johnnn", first_name: "John", last_name:"Wick", address: "Brunswick", phone_number:"12345",image_url:"https://i.pravatar.cc/150?img=64")
